...
Rust workspace. 9 crates, ~72K lines. Neuroplastic fluid cognitive architecture: Bloch sphere state geometry, unified encoder-decoder (16M params), hot-swappable WASM cognitive modules. Published on crates.io.
