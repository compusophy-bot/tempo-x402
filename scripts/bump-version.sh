...
CRATES=("tempo-x402" "tempo-x402-client" "tempo-x402-server" "tempo-x402-facilitator" "tempo-x402-gateway" "tempo-x402-wallet" "tempo-x402-app" "tempo-x402-security-audit" "tempo-x402-identity" "tempo-x402-agent" "tempo-x402-node")
