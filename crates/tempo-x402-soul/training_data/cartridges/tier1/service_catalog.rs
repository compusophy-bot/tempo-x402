...
pub extern "C" fn x402_handle(request_ptr: *const u8, request_len: i32) {
    host_log(0, "service_catalog: serving");
    respond(200, r#"{"service":"service_catalog","status":"ok","data":{"message":"service_catalog endpoint active","version":"1.0"}}"#, "application/json");
}
