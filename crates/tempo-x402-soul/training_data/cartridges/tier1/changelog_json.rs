...
pub extern "C" fn x402_handle(request_ptr: *const u8, request_len: i32) {
    host_log(0, "changelog_json: serving");
    respond(200, r#"{"service":"changelog_json","status":"ok","data":{"message":"changelog_json endpoint active","version":"1.0"}}"#, "application/json");
}
