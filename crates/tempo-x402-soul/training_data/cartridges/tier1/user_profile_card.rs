...
pub extern "C" fn x402_handle(request_ptr: *const u8, request_len: i32) {
    host_log(0, "user_profile_card: serving");
    respond(200, r#"{"service":"user_profile_card","status":"ok","data":{"message":"user_profile_card endpoint active","version":"1.0"}}"#, "application/json");
}
